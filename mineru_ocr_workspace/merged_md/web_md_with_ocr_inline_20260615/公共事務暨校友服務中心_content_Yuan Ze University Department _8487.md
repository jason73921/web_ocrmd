# 網站文章資料_Yuan Ze University Department of Art and Design Won Silver at the 2025 MUSE Creative Awards_8487

## 一、文章基本資料

- **文章ID**: 8487
- **文章標題**: Yuan Ze University Department of Art and Design Won Silver at the 2025 MUSE Creative Awards
- **文章網址**: 
- **文章簡介**: The Department of Art and Design at Yuan Ze University stood out among more than 9,000 entries worldwide to win a Silver Award at the 2025 MUSE Creative Awards, once again showcasing the outstanding achievements and boundless creativity of Taiwan’s design education on the international stage.
...
- **文章全文**: 
- **文章更新日期**: 2025/4/21 上午 01:45:29
- **文章發表日期**: 2025/4/21 上午 01:45:29
- **文章點擊數**: 576
- **文章語系**: en-US
...
- **1. [圖片]**: images/20250410.jpg

<!-- OCR inline block inserted by Merge-OcrMarkdownIntoWebMd.py -->
<!-- OCR_BEGIN relationIndex=1 assetId=d1c5e4d4a955b6e3 -->
#### OCR 1: images/20250410.jpg

- 關聯類型: 圖片
- 本機檔案: admin/pr/images/20250410.jpg
- OCR Markdown: /mnt/project/cache/ocr_completed_cache/ocr_md_assets/d1c5e4d4a955b6e3_20250410.md
- OCR 狀態: completed_cached
- OCR 字數: 80
- 驗證狀態: ok

```markdown
![](images/e4fbe04c9b9616beb8bbfeb58f987457254878549beb065e9d838e30fbcdabb3.jpg)
```
